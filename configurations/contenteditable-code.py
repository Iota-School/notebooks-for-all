...
c.Html5.cell_contenteditable = True  # make cell code inputs contenteditable
c.Html5.cell_contenteditable_label = True  # aria-label on contenteditable cells
...
c.Html5.scroll_to_top = True  # add a shortcut in the footer to scroll the the top
